...
<form action="<?= url('admin/purchase-orders/store') ?>" method="POST" id="poForm">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="tax_amount" class="form-control" value="0" min="0" step="0.01" onchange="calculateTotals()">
                    </div>

                    <div class="mb-3">
                        <label class="form-label small">Shipping Amount</label>
                        <input type="number" name="shipping_amount" class="form-control" value="0" min="0" step="0.01" onchange="calculateTotals()">
                    </div>
